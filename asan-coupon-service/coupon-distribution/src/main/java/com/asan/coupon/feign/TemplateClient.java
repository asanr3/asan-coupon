...
import com.asan.coupon.feign.hystrix.TemplateClientHystrix;
 ...
 * @author Asan
 * 使用Feign注解标注当前定义一个Feign客户端  是springcloud的一个微服务组件，负责微服务之间的调用
 * value 声明 "eureka-client-coupon-template" 指定想要调用的微服务名称
 * fallback 定义降级策略Hystrix
 */
